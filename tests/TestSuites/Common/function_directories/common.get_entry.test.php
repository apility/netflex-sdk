...
final class Common_GetEntryTest extends TestCase
{
  ...
  public function testCanRetrieveFromCache (): void
  {
    ...
    $this->assertMatchesJsonSnapshot(get_entry(10000));
  }
  ...
  public function testCanFetchFromApi (): void
  {
    ...
    $this->assertMatchesJsonSnapshot(get_entry(10001));
  }

  public function testHandlesNotFound (): void
  {
    NF::$capi->mockResponse(new Response(404));
    $this->assertEmpty(get_entry(10002));
  }
