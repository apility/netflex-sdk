...
function generateUrl($entry)
{
    ...
    if ($structure['url_scheme'] == 'url/') {
        ...
        $url = $url . $url_asset[1] . '/';
    } elseif ($structure['url_scheme'] == 'id/') {
        $url_asset[1] = $entry['id'];
        $url = $url . $url_asset[1] . '/';
    } elseif ($structure['url_scheme'] == 'id/url/') {
        $url_asset[1] = rtrim($entry['url'], '/');
        $url_asset[2] = $entry['id'];
        $url = $url . $url_asset[2] . '/' . $url_asset[1] . '/';
    } elseif ($structure['url_scheme'] == 'yyyy/mm/dd/url/') {
        $url_asset[1] = rtrim($entry['url'], '/');
    ...
    } elseif ($structure['url_scheme'] == 'yyyy/mm/url/') {
        $url_asset[1] = rtrim($entry['url'], '/');
    ...
    } elseif ($structure['url_scheme'] == 'yyyy/url/') {
        $url_asset[1] = rtrim($entry['url'], '/');
